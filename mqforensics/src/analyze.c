...
static inline long long site_base_count(const Site *s, int slot){
    switch (slot) {
        ...
        case 2: return s->nG_fwd;
        case 3: return s->nT_fwd;
        case 4: return s->nN_fwd;
        case 5: return s->nA_rev;
        case 6: return s->nC_rev;
        case 7: return s->nG_rev;
        case 8: return s->nT_rev;
        case 9: return s->nN_rev;
        default: return 0ULL;
    }
}
